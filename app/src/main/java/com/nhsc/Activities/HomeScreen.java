...
public class HomeScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setBackgroundDrawable(ContextCompat.getDrawable(this,R.drawable.email));
        ...
        prepareListData();
    //    mMenuAdapter = new HomeScreen_Expandable_Adapter(this, listDataHeader, listDataChild, expandableList);
